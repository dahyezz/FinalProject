...
<div class="text-center">
	<ul class="pagination pagination-sm">
		...
		<li>
			<a href="/admin/member?curPage=${paging.curPage-1 }&search=${param.search }"><span>&laquo;</span></a>
	    </li>
	    </c:if>
		...
		<c:forEach
	     ...
	     var="i">
			...
			<li class="active">
				<a href="/admin/member?curPage=${i }&search=${param.search }">${i }</a>
			</li>
			</c:if>
		...
		<li>
			<a href="/admin/member?curPage=${paging.curPage+1 }&search=${param.search }">
			<span>&raquo;</span>
		</a>
		</li>
		</c:if>
