...
public class TempTable {
	...
	public String toString() {
		return "TempTable [user_email=" + user_email + ", lecture_code=" + lecture_code + ", grade=" + grade
				+ ", lecture_section=" + lecture_section + ", department_name=" + department_name + ", lecture_name="
				+ lecture_name + ", hakjum=" + hakjum + ", professor_name=" + professor_name + ", lecture_day="
				+ lecture_day + ", start_time=" + start_time + ", end_time=" + end_time + ", lecture_room="
				+ lecture_room + "]";
	}
